...
CREATE TABLE overseas_reports (
    ...
    registration_no VARCHAR(100) COMMENT '注册证编号',
    registration_no_en VARCHAR(100) COMMENT 'Registration no.',
    module VARCHAR(100) COMMENT '型号',
    module_en VARCHAR(100) COMMENT 'Module',
    package VARCHAR(100) COMMENT '规格',
    package_en VARCHAR(100) COMMENT 'Package',
    origin_country VARCHAR(100) COMMENT '产地',
    origin_country_en VARCHAR(100) COMMENT 'Origin of Country',
